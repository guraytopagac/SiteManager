CREATE TABLE users_new (
  ...
  display_name TEXT CHECK(display_name IS NULL OR length(display_name) BETWEEN 2 AND 60),
...
INSERT INTO users_new (
  id, username, email, display_name, password_hash, recovery_hash,
  role, is_active, last_login, password_changed_at, created_at, updated_at
)
SELECT
  id, username, email, display_name, password_hash, recovery_hash,
  role, is_active, last_login, password_changed_at, created_at, updated_at
